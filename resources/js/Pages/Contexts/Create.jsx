                    ...
                    <div className="bg-white shadow-xl rounded-2xl p-8 space-y-6 transition-all">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition resize-none ${errors.description ? 'border-red-500' : 'border-gray-300'
                                        }`}
                                    rows="4"
                                    value={data.description}
                                    onChange={(e) => setData('description', e.target.value)}
                                    placeholder="Describe brevemente el propósito de este contexto"
                                ></textarea>
                                {errors.description && (
