...
export default function Create() {
    const { tags, contexts, priorities, statuses } = usePage().props;
    ...
    return (
        <AuthenticatedLayout
            header={
                <h2 className="text-2xl font-bold text-gray-900">Crear Nota</h2>
            }
        >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition ${errors.context_id ? 'border-red-500' : 'border-gray-300'}`}
                                >
                                ...
                                {errors.context_id && <p className="text-red-600 text-sm mt-1">{errors.context_id}</p>}
                            </div>
